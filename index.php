<?php
// =========================================================
// 💖 CONFIGURATION: ENCHANTED PRINCESS EDITION (UPDATED) 💖
// =========================================================

$wifeName = "Simin"; 
$pageTitle = "For My Princess, " . $wifeName;

// 1. MUSIC
$musicFile = ""; // Upload mp3 and put name here (e.g., 'song.mp3')
...
Happy Birthday to the most beautiful woman in my life — my wife, my best friend, my peace, and my greatest blessing.
...
Thank you for loving me the way you do, for supporting me even when things aren’t easy, and for filling our home with warmth, laughter, and care. You make my life complete in ways words can never fully express.
...
// 5. THE GIFT
$giftTitle = "A Spa Day Just for You";
$giftSubtitle = "Relax, unwind, and let me take care of everything.";

// --- SURPRISE FEATURES CONFIGURATION ---

// 6. "REASONS I LOVE YOU" LIST
$loveReasons = [
...
// 7. COUNTDOWN TIMER
$targetDate = "October 25, 2025 19:00:00"; 
$countdownTitle = "Time until our special dinner:";

// 8. THE MEMORY VAULT
$vaultQuestion = "Where was our first date?"; // The question
$vaultAnswer = "BFC"; // The answer (make sure it's lowercase for checking)
$vaultSecretMessage = "You remembered! That was the day my life truly began.";
$vaultSecretImage = "5.jpeg"; 
...
<head>
    ...
    <style>
        ...
        .letter-open p { line-height: 1.8; color: #555; font-size: 1.1rem; }
...
<body>
    ...
    <div class="kiss-btn" onclick="sendKisses()">💋</div>

    <div class="glass-card">
        <div class="avatar-container">
            <div class="crown">👑</div>
            <img src="<?php echo $avatarImg; ?>" class="avatar-img">
        </div>

        <h1><?php echo $wifeName; ?></h1>

        <p style="color: var(--pink-deep); font-weight: bold; margin-bottom: 5px;"><?php echo $countdownTitle; ?></p>
        ...
        <div class="love-generator-box">
            ...
            <button class="love-btn" onclick="newReason()">Tell me why ❤️</button>
        </div>
        ...
        <div class="vault-box">
            ...
            <p style="font-size: 0.9rem; margin: 5px 0;"><?php echo $vaultQuestion; ?></p>
            ...
            <div class="hidden-vault-content" id="vaultContent">
                <p style="color: var(--pink-deep); font-weight: bold; font-size: 1.1rem;"><?php echo $vaultSecretMessage; ?></p>
                <img src="<?php echo $vaultSecretImage; ?>" class="vault-img">
            </div>
        </div>
        ...
        <div class="envelope-wrapper" onclick="openLetter()">
            ...
            <div class="letter-open" id="letterOpen">
                <p><?php echo nl2br($letterContent); ?></p>
                <div style="text-align: right; color: var(--pink-hot); font-weight: bold;">- Your Hubby</div>
            </div>
        </div>
        ...
        <div class="gift-content" id="giftContent">
            <h2 style="font-family: 'Fredoka One'; color: var(--pink-deep); margin-bottom: 5px;"><?php echo $giftTitle; ?></h2>
            <p style="font-weight: bold; color: #555;"><?php echo $giftSubtitle; ?></p>
    ...
    <script>
        // --- PHP DATA TO JS ---
        const loveReasons = <?php echo json_encode($loveReasons); ?>;
        const targetDate = new Date("<?php echo $targetDate; ?>").getTime();
        const correctAnswer = "<?php echo strtolower($vaultAnswer); ?>";
        ...
        const timer = setInterval(function() {
            ...
            if (distance < 0) {
                document.getElementById("countdown").innerHTML = "<div style='font-weight:bold; color:white;'>It's Time! 🎉</div>";
                return;
            }
